...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Integer[] mResourseIds = new Integer[arrayList.size()];
		mResourseIds = (Integer[]) arrayList.toArray(mResourseIds);


		// TODO: Start the DownloaderTask
		dt.execute(mResourseIds);
	...
	public class DownloaderTask extends AsyncTask<Integer[], Void, String[]>{
		...
		protected String[] doInBackground(Integer[]... params) {
			Integer[] resourseIDS = params[0];
			String[] feed = downloadTweets(resourseIDS);
			return feed;
		}
		...
		protected void onPostExecute(String[] feed) {
			...
			mCallback.notifyDataRefreshed(feed);
		}
	}
